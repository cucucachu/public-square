  ...
  describe('Nomination Model Tests', function () {
    describe('Nomination.create()', function () {
      it('Nomination.create() creates a Nomination instance.', function () {
        ...
        assert(_typeof(nomination) === "object");
      });
      it('Nomination.create() creates a Nomination instance with _id field populated', function () {
        var nomination = Nomination.create();
        assert(_typeof(nomination._id) === "object" && /^[a-f\d]{24}$/i.test(nomination._id));
      });
    });
    describe('Nomination.save()', function () {
      it('Nomination.save() throws an error if required fields are missing.', function (done) {
        ...
        Nomination.save(nomination).then(function (result) {
          ...
          if (testFailed) done(new Error('Nomination.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('Nomination.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('Nominator Model Tests', function () {
    describe('Nominator.create()', function () {
      it('Nominator.create() creates a Nominator instance.', function () {
        ...
        assert(_typeof(nominator) === "object");
      });
      it('Nominator.create() creates a Nominator instance with _id field populated', function () {
        var nominator = Nominator.create();
        assert(_typeof(nominator._id) === "object" && /^[a-f\d]{24}$/i.test(nominator._id));
      });
    });
    describe('Nominator.save()', function () {
      it('Nominator.save() throws an error if required fields are missing.', function (done) {
        ...
        Nominator.save(nominator).then(function (result) {
          testFailed = 1;
        }, function (rejectionErr) {
          error = rejectionErr;
        }).finally(function () {
          if (testFailed) done(new Error('Nominator.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('Nominator.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('Nominee Model Tests', function () {
    describe('Nominee.create()', function () {
      it('Nominee.create() creates a Nominee instance.', function () {
        ...
        assert(_typeof(nominee) === "object");
      });
      it('Nominee.create() creates a Nominee instance with _id field populated', function () {
        var nominee = Nominee.create();
        assert(_typeof(nominee._id) === "object" && /^[a-f\d]{24}$/i.test(nominee._id));
      });
    });
    describe('Nominee.save()', function () {
      it('Nominee.save() throws an error if required fields are missing.', function (done) {
        ...
        Nominee.save(nominee).then(function (result) {
          ...
          if (testFailed) done(new Error('Nominee.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('Nominee.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('ConfirmationVote Model Tests', function () {
    describe('ConfirmationVote.create()', function () {
      it('ConfirmationVote.create() creates a ConfirmationVote instance.', function () {
        ...
        assert(_typeof(confirmationVote) === "object");
      });
      it('ConfirmationVote.create() creates a ConfirmationVote instance with _id field populated', function () {
        var confirmationVote = ConfirmationVote.create();
        assert(_typeof(confirmationVote._id) === "object" && /^[a-f\d]{24}$/i.test(confirmationVote._id));
      });
    });
    describe('ConfirmationVote.save()', function () {
      it('ConfirmationVote.save() throws an error if required fields are missing.', function (done) {
        ...
        ConfirmationVote.save(confirmationVote).then(function (result) {
          testFailed = 1;
        }, function (rejectionErr) {
          error = rejectionErr;
        }).finally(function () {
          if (testFailed) done(new Error('ConfirmationVote.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('ConfirmationVote.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('IndividualConfirmationVote Model Tests', function () {
    describe('IndividualConfirmationVote.create()', function () {
      it('IndividualConfirmationVote.create() creates a IndividualConfirmationVote instance.', function () {
        ...
        assert(_typeof(individualConfirmationVote) === "object");
      });
      it('IndividualConfirmationVote.create() creates a IndividualConfirmationVote instance with _id field populated', function () {
        var individualConfirmationVote = IndividualConfirmationVote.create();
        assert(_typeof(individualConfirmationVote._id) === "object" && /^[a-f\d]{24}$/i.test(individualConfirmationVote._id));
      });
    });
    describe('IndividualConfirmationVote.save()', function () {
      it('IndividualConfirmationVote.save() throws an error if required fields are missing.', function (done) {
        ...
        IndividualConfirmationVote.save(individualConfirmationVote).then(function (result) {
          testFailed = 1;
        }, function (rejectionErr) {
          error = rejectionErr;
        }).finally(function () {
          if (testFailed) done(new Error('IndividualConfirmationVote.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('IndividualConfirmationVote.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('ConfirmationVoteOption Model Tests', function () {
    describe('ConfirmationVoteOption.create()', function () {
      it('ConfirmationVoteOption.create() creates a ConfirmationVoteOption instance.', function () {
        ...
        assert(_typeof(confirmationVoteOption) === "object");
      });
      it('ConfirmationVoteOption.create() creates a ConfirmationVoteOption instance with _id field populated', function () {
        var confirmationVoteOption = ConfirmationVoteOption.create();
        assert(_typeof(confirmationVoteOption._id) === "object" && /^[a-f\d]{24}$/i.test(confirmationVoteOption._id));
      });
    });
    describe('ConfirmationVoteOption.save()', function () {
      it('ConfirmationVoteOption.save() throws an error if required fields are missing.', function (done) {
        ...
        ConfirmationVoteOption.save(confirmationVoteOption).then(function (result) {
          testFailed = 1;
        }, function (rejectionErr) {
          error = rejectionErr;
        }).finally(function () {
          if (testFailed) done(new Error('ConfirmationVoteOption.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('ConfirmationVoteOption.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
  ...
  describe('Confirmer Model Tests', function () {
    describe('Confirmer.create()', function () {
      it('Confirmer.create() creates a Confirmer instance.', function () {
        ...
        assert(_typeof(confirmer) === "object");
      });
      it('Confirmer.create() creates a Confirmer instance with _id field populated', function () {
        var confirmer = Confirmer.create();
        assert(_typeof(confirmer._id) === "object" && /^[a-f\d]{24}$/i.test(confirmer._id));
      });
    });
    describe('Confirmer.save()', function () {
      it('Confirmer.save() throws an error if required fields are missing.', function (done) {
        ...
        Confirmer.save(confirmer).then(function (result) {
          testFailed = 1;
        }, function (rejectionErr) {
          error = rejectionErr;
        }).finally(function () {
          if (testFailed) done(new Error('Confirmer.save() promise resolved when it should have been rejected with Validation Error'));else {
            if (error != null && error.message == expectedErrorMessage) {
              done();
            } else {
              done(new Error('Confirmer.save() did not return the correct Validation Error.\n' + '   Expected: ' + expectedErrorMessage + '\n' + '   Actual:   ' + error.message));
            }
          }
        });
      });
