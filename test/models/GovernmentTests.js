...
const VoteOption = require('../../src/models/Modules/Government/VoteOption');
const GovernmentRole = require('../../src/models/Modules/Government/GovernmentRole');
const PositionAcquisitionProcess = require('../../src/models/Modules/Government/PositionAcquisitionProcess');
const EffectivePositionDefinition = require('../../src/models/Modules/Government/EffectivePositionDefinition');
const Government = require('../../src/models/Modules/Government/Government');
const GovernmentInstitution = require('../../src/models/Modules/Government/GovernmentInstitution');
const GovernmentOfficial = require('../../src/models/Modules/Government/GovernmentOfficial');
const GovernmentPosition = require('../../src/models/Modules/Government/GovernmentPosition');
const GovernmentPower = require('../../src/models/Modules/Government/GovernmentPower');
const Law = require('../../src/models/Modules/Government/Law');
const OccupiedPosition = require('../../src/models/Modules/Government/OccupiedPosition');
const PositionDefinition = require('../../src/models/Modules/Government/PositionDefinition');
const TermDefinition = require('../../src/models/Modules/Government/TermDefinition');
