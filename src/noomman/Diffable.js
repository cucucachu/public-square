...
/*
 * Class Diffable
 * This class contains all the methods necesary for producing diff objects for updating
...
class Diffable {
     ...
     * Returns
     * - Object - An diff object in the format of a mongo update operation object, except that operations are 
     ...
     * Returns
     * - String - will return a string value which is either '$addToSet' or '$pull'.
     */
     ...
     * Retrieves the value of the relationship with given name in the given diff
     ...
     *    reducedRelatedDiffs, accept is meant to be used when gathering all the related instances
